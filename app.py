...
import pathlib, datetime as dt, time, uuid, logging
...
@login_required
def assign():
    sid = request.json.get("student_id"); tid = request.json.get("song_id")
...
with app.app_context():
    ...
    if not User.query.first():
        ...
        for t,d in [("Bluestone Alley",2),("Smells like teen spirit",1),
                    ("Horimia",3)]:
